...
privileged aspect TodoIntegrationTest_Roo_IntegrationTest {
    ...
    @Autowired
    TodoDataOnDemand TodoIntegrationTest.dod;
    
    @Autowired
    TodoService TodoIntegrationTest.todoService;
    
    @Autowired
    TodoRepository TodoIntegrationTest.todoRepository;
    
    @Test
    public void TodoIntegrationTest.testCountAllTodoes() {
    ...
    @Test
    public void TodoIntegrationTest.testUpdateTodoUpdate() {
        Todo obj = dod.getRandomTodo();
        Assert.assertNotNull("Data on demand for 'Todo' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Todo' failed to provide an identifier", id);
    ...
    @Test
    public void TodoIntegrationTest.testSaveTodo() {
        Assert.assertNotNull("Data on demand for 'Todo' failed to initialize correctly", dod.getRandomTodo());
    ...
    @Test
    public void TodoIntegrationTest.testDeleteTodo() {
        Todo obj = dod.getRandomTodo();
        Assert.assertNotNull("Data on demand for 'Todo' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Todo' failed to provide an identifier", id);
