...
privileged aspect UserinfoIntegrationTest_Roo_IntegrationTest {
    ...
    @Autowired
    UserService UserinfoIntegrationTest.userService;
    
    @Autowired
    UserRepository UserinfoIntegrationTest.userRepository;
    ...
    @Test
    public void UserinfoIntegrationTest.testFlush() {
        Userinfo obj = dod.getRandomUserinfo();
        Assert.assertNotNull("Data on demand for 'Userinfo' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Userinfo' failed to provide an identifier", id);
    ...
    @Test
    public void UserinfoIntegrationTest.testUpdateUserinfoUpdate() {
        Userinfo obj = dod.getRandomUserinfo();
        Assert.assertNotNull("Data on demand for 'Userinfo' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Userinfo' failed to provide an identifier", id);
